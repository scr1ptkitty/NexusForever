...
namespace NexusForever.WorldServer.Command.Handler
{
    ...
    public class AchievementCommandHandler : CommandCategory
    {
        ...
        [SubCommandHandler("update", "type objectId objectIdAlt count - Update all achievement criteria with type and object ids by count.", Permission.CommandAchievement)]
        ...
        [SubCommandHandler("grant", "achievementId - Grant the specific achievement.", Permission.CommandAchievement)]
