...
using NLog;
using System;
using ContactsEntry = NexusForever.WorldServer.Database.Character.Model.Contacts;
...
namespace NexusForever.WorldServer.Game.Contact
{
    public class Contact : ISaveCharacter
    {
        ...
        /// </summary>
        public Contact(ContactsEntry model)
        {
            Id = model.Id;
        ...
        public void Save(CharacterContext context)
        {
            ...
            {
                ContactManager.RemoveFromCache(this);

                if (HasBeenCreated)
                {
                    var model = new ContactsEntry
                    {
                        Id = Id,
                        OwnerId = OwnerId,
                        ContactId = ContactId,
