...
namespace NexusForever.WorldServer.Command.Handler
{
    ...
    public class DoorCommandHandler : CommandCategory
    {
        ...
        [SubCommandHandler("open", "[range] - Open all doors within a given range (Defaults to 10m).", Permission.CommandDoor)]
        ...
        [SubCommandHandler("close", "[range] - Close all doors within a given range (Defaults to 10m).", Permission.CommandDoor)]
